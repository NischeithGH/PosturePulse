...
.gr-plot{
    ...
    """,css=css1) as demo:
        ...
        # demo.load(
        #     fn=lambda: inference.sync_selected_model(MODEL_YOLO),
        #     inputs=None,
        ...
        demo.load(
    fn=lambda: inference.sync_selected_model(MODEL_POSE),
    inputs=None,
    outputs=model.selected_model,
    show_progress="hidden",
)
...
def launch_dashboard(ctx: AppContext, demo: gr.Blocks) -> None:
    ...
    print("Allowed path:")
    print("/home/student/2025-26-projectone-ctai-BoddapatiNischeith/RPi/ui/assests")
    ...
    demo.queue().launch(
        ...
        show_error=True,
        allowed_paths=[
    "/home/student/2025-26-projectone-ctai-BoddapatiNischeith/RPi/ui/assests"]
    )
